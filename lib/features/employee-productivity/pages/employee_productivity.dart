                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildProductivityCard(
                        context,
                        title: localizations.introEmployeeListTitle,
                        subtitle: localizations.introEmployeeListSubtitle,
                        icon: Icons.school_outlined,
                        gradientColors: [
                          AppColors.cx4AC1A7,
                          AppColors.cx4AC1A7.withOpacity(0.8),
                        ],
                        onTap: () => context.push('/introEmployeeList'),
                        isDark: isDark,
                        theme: theme,
                      ),
                    ],
